...
OCI workload identity is proven from site, Nomad namespace/job/group/task, and OCI root or manifest digest; runtime UIDs are allocator-owned execution details, not service identity.
