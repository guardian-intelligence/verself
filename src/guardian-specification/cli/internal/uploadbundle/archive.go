...
var RequiredBuildArtifacts = []RequiredArtifact{
	...
	{
		Source: "bazel-bin/src/infrastructure-components/nftables/nftables-runtime.tar",
		Target: "bazel-bin/src/infrastructure-components/nftables/nftables-runtime.tar",
		Mode:   "0644",
	},
	{
		Source: "bazel-bin/src/infrastructure-components/nftables/cmd/nftables-apply/nftables-apply_/nftables-apply",
		Target: "bazel-bin/src/infrastructure-components/nftables/cmd/nftables-apply/nftables-apply_/nftables-apply",
		Mode:   "0755",
	},
	{
		Source: "bazel-bin/src/infrastructure-components/nats/nats-runtime.tar",
		Target: "bazel-bin/src/infrastructure-components/nats/nats-runtime.tar",
		Mode:   "0644",
	},
	{
		Source: "bazel-bin/src/infrastructure-components/nats/cmd/nats-recover/nats-recover_/nats-recover",
		Target: "bazel-bin/src/infrastructure-components/nats/cmd/nats-recover/nats-recover_/nats-recover",
		Mode:   "0755",
	},
	{
	...
	{
		Source: "bazel-bin/src/infrastructure-components/nomad-observer/cmd/nomad-observer/nomad-observer_/nomad-observer",
		Target: "bazel-bin/src/infrastructure-components/nomad-observer/cmd/nomad-observer/nomad-observer_/nomad-observer",
		Mode:   "0755",
	},
	{
		Source: "bazel-bin/src/infrastructure-components/otelcol/otelcol-runtime.tar",
		Target: "bazel-bin/src/infrastructure-components/otelcol/otelcol-runtime.tar",
		Mode:   "0644",
	},
	{
		Source: "bazel-bin/src/infrastructure-components/otelcol/otelcol-config.tar",
		Target: "bazel-bin/src/infrastructure-components/otelcol/otelcol-config.tar",
		Mode:   "0644",
	},
	{
		Source: "bazel-bin/src/infrastructure-components/otelcol/cmd/otelcol-recover/otelcol-recover_/otelcol-recover",
		Target: "bazel-bin/src/infrastructure-components/otelcol/cmd/otelcol-recover/otelcol-recover_/otelcol-recover",
		Mode:   "0755",
	},
	{
	...
	{
		Source: "bazel-bin/src/infrastructure-components/tigerbeetle/cmd/tigerbeetle-recover/tigerbeetle-recover_/tigerbeetle-recover",
		Target: "bazel-bin/src/infrastructure-components/tigerbeetle/cmd/tigerbeetle-recover/tigerbeetle-recover_/tigerbeetle-recover",
		Mode:   "0755",
	},
	{
		Source: "bazel-bin/src/infrastructure-components/zot/zot-runtime.tar",
		Target: "bazel-bin/src/infrastructure-components/zot/zot-runtime.tar",
		Mode:   "0644",
	},
	{
		Source: "bazel-bin/src/infrastructure-components/zot/cmd/zot-recover/zot-recover_/zot-recover",
		Target: "bazel-bin/src/infrastructure-components/zot/cmd/zot-recover/zot-recover_/zot-recover",
		Mode:   "0755",
	},
	{
		Source: "bazel-bin/src/infrastructure-components/verdaccio/verdaccio-runtime.tar",
		Target: "bazel-bin/src/infrastructure-components/verdaccio/verdaccio-runtime.tar",
		Mode:   "0644",
	},
	{
		Source: "bazel-bin/src/infrastructure-components/verdaccio/cmd/verdaccio-recover/verdaccio-recover_/verdaccio-recover",
		Target: "bazel-bin/src/infrastructure-components/verdaccio/cmd/verdaccio-recover/verdaccio-recover_/verdaccio-recover",
		Mode:   "0755",
	},
	{
	...
	{
		Source: "bazel-bin/src/infrastructure-components/forgejo/forgejo-runtime.tar",
		Target: "bazel-bin/src/infrastructure-components/forgejo/forgejo-runtime.tar",
		Mode:   "0644",
	},
	{
		Source: "bazel-bin/src/infrastructure-components/forgejo/cmd/forgejo-recover/forgejo-recover_/forgejo-recover",
		Target: "bazel-bin/src/infrastructure-components/forgejo/cmd/forgejo-recover/forgejo-recover_/forgejo-recover",
		Mode:   "0755",
	},
	{
		Source: "bazel-bin/src/infrastructure-components/stalwart/stalwart-runtime.tar",
		Target: "bazel-bin/src/infrastructure-components/stalwart/stalwart-runtime.tar",
		Mode:   "0644",
	},
	{
		Source: "bazel-bin/src/infrastructure-components/stalwart/cmd/stalwart-recover/stalwart-recover_/stalwart-recover",
		Target: "bazel-bin/src/infrastructure-components/stalwart/cmd/stalwart-recover/stalwart-recover_/stalwart-recover",
		Mode:   "0755",
	},
	{
		Source: "bazel-bin/src/infrastructure-components/electric/electric-runtime.tar",
		Target: "bazel-bin/src/infrastructure-components/electric/electric-runtime.tar",
		Mode:   "0644",
	},
	{
		Source: "bazel-bin/src/infrastructure-components/electric/cmd/electric-recover/electric-recover_/electric-recover",
		Target: "bazel-bin/src/infrastructure-components/electric/cmd/electric-recover/electric-recover_/electric-recover",
		Mode:   "0755",
	},
	{
	...
	{
		Source: "bazel-bin/src/infrastructure-components/zitadel/cmd/zitadel-setup-apply/zitadel-setup-apply_/zitadel-setup-apply",
		Target: "bazel-bin/src/infrastructure-components/zitadel/cmd/zitadel-setup-apply/zitadel-setup-apply_/zitadel-setup-apply",
		Mode:   "0755",
	},
	{
		Source: "bazel-bin/src/infrastructure-components/zitadel/cmd/auth-control-plane-apply/auth-control-plane-apply_/auth-control-plane-apply",
		Target: "bazel-bin/src/infrastructure-components/zitadel/cmd/auth-control-plane-apply/auth-control-plane-apply_/auth-control-plane-apply",
		Mode:   "0755",
	},
	{
		Source: "bazel-bin/src/infrastructure-components/temporal-platform/temporal-runtime.tar",
		Target: "bazel-bin/src/infrastructure-components/temporal-platform/temporal-runtime.tar",
		Mode:   "0644",
	},
	{
		Source: "bazel-bin/src/infrastructure-components/temporal-platform/cmd/temporal-recover/temporal-recover_/temporal-recover",
		Target: "bazel-bin/src/infrastructure-components/temporal-platform/cmd/temporal-recover/temporal-recover_/temporal-recover",
		Mode:   "0755",
	},
	{
	...
	{
		Source: "bazel-bin/src/services/object-storage-service/cmd/object-storage-service/object-storage-service_/object-storage-service",
		Target: "bazel-bin/src/services/object-storage-service/cmd/object-storage-service/object-storage-service_/object-storage-service",
		Mode:   "0755",
	},
}
...
func WorkspaceFiles(repoRoot string) ([]File, error) {
	...
	if len(missing) > 0 {
		return nil, fmt.Errorf("required build artifacts are missing; run bazelisk build //src/guardian-specification/cli/cmd/guardian:guardian //src/infrastructure-components/nomad:runtime_artifact //src/infrastructure-components/nomad/cmd/nomad-recover:nomad-recover //src/infrastructure-components/openbao:runtime_artifact //src/infrastructure-components/openbao/cmd/openbao-recover:openbao-recover //src/infrastructure-components/haproxy:runtime_artifact //src/infrastructure-components/nftables:runtime_artifact //src/infrastructure-components/nftables/cmd/nftables-apply:nftables-apply //src/infrastructure-components/nats:runtime_artifact //src/infrastructure-components/nats/cmd/nats-recover:nats-recover //src/infrastructure-components/spire:runtime_artifact //src/infrastructure-components/spire:identity_registry //src/infrastructure-components/spire:spire-recover //src/infrastructure-components/nomad-observer/cmd/nomad-observer:nomad-observer //src/infrastructure-components/nomad-observer/cmd/nomad-observer:nomad-observer_nomad_artifact //src/infrastructure-components/otelcol:runtime_artifact //src/infrastructure-components/otelcol:config_artifact //src/infrastructure-components/otelcol/cmd/otelcol-recover:otelcol-recover //src/infrastructure-components/postgresql:runtime_artifact //src/infrastructure-components/clickhouse:runtime_artifact //src/infrastructure-components/clickhouse/cmd/clickhouse-recover:clickhouse-recover //src/infrastructure-components/spicedb:runtime_artifact //src/infrastructure-components/spicedb/cmd/spicedb-recover:spicedb-recover //src/infrastructure-components/tigerbeetle:runtime_artifact //src/infrastructure-components/tigerbeetle/cmd/tigerbeetle-recover:tigerbeetle-recover //src/infrastructure-components/zot:runtime_artifact //src/infrastructure-components/zot/cmd/zot-recover:zot-recover //src/infrastructure-components/verdaccio:runtime_artifact //src/infrastructure-components/verdaccio/cmd/verdaccio-recover:verdaccio-recover //src/infrastructure-components/grafana:runtime_artifact //src/infrastructure-components/grafana/cmd/grafana-recover:grafana-recover //src/infrastructure-components/forgejo:runtime_artifact //src/infrastructure-components/forgejo/cmd/forgejo-recover:forgejo-recover //src/infrastructure-components/stalwart:runtime_artifact //src/infrastructure-components/stalwart/cmd/stalwart-recover:stalwart-recover //src/infrastructure-components/electric:runtime_artifact //src/infrastructure-components/electric/cmd/electric-recover:electric-recover //src/infrastructure-components/zitadel:runtime_artifact //src/infrastructure-components/zitadel/cmd/zitadel-setup-apply:zitadel-setup-apply //src/infrastructure-components/zitadel/cmd/auth-control-plane-apply:auth-control-plane-apply //src/infrastructure-components/temporal-platform:runtime_artifact //src/infrastructure-components/temporal-platform/cmd/temporal-recover:temporal-recover //src/integrations/cloudflare/control-plane:runtime_artifact //src/services/object-storage-service/cmd/object-storage-service:object-storage-service //src/services/object-storage-service/cmd/object-storage-service:object-storage-service_nomad_artifact: %s", strings.Join(missing, "; "))
	}
	return files, nil
}
