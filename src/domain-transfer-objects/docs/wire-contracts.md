...
`src/domain-transfer-objects` owns transfer contracts shared by Go services, OpenAPI specs, protobuf schemas, generated TypeScript clients, and app-facing TypeScript wrappers. Service domain packages can keep native Go types and service-local aliases. Huma boundary structs own JSON encoding and generated schema.
