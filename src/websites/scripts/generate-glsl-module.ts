...
function configFromArgs(): GlslModule {
  ...
  return {
    ...
    sources,
    symbolPrefix: validateSymbolPrefix(optionalArg("symbol-prefix", "firstLight")),
  };
}
...
function emitModule(
  ...
  return [
    "// @ts-nocheck",
    "// Generated by //src/websites/scripts:generate_glsl_module.",
...
const output = emitModule(vertex, fragment, uniforms, config.symbolPrefix);
