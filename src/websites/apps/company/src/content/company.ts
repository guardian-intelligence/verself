...
export const COMPANY_META = {
  title: "Company — Guardian",
  description:
    "Guardian is an American applied intelligence firm, based in Seattle. We build the reference architecture for one-founder companies.",
} as const;
...
export const company = {
  ...
  paragraphs: [
    "Guardian is an American applied intelligence firm. We build compute, integrations, and founder tooling — the systems every company needs before it can build what its founders actually started the company to build.",
