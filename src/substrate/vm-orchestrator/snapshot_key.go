...
const (
	GoldenVMSnapshotKeySchema         = "fc-precontrol-chrony-v6"
	GoldenVMRestoreHookVersion        = "lease-init+host-clock-first+chrony-restart-v4"
	GoldenVMBeforeSnapshotHookVersion = "before_golden_snapshot.stop_chronyd_v4"
