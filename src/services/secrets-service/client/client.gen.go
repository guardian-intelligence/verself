...
// Defines values for ResolveSecretsBodyScopeLevel.
const (
	ResolveSecretsBodyScopeLevelBranch      ResolveSecretsBodyScopeLevel = "branch"
	ResolveSecretsBodyScopeLevelEnvironment ResolveSecretsBodyScopeLevel = "environment"
	ResolveSecretsBodyScopeLevelOrg         ResolveSecretsBodyScopeLevel = "org"
	ResolveSecretsBodyScopeLevelSource      ResolveSecretsBodyScopeLevel = "source"
)

// Valid indicates whether the value is a known member of the ResolveSecretsBodyScopeLevel enum.
func (e ResolveSecretsBodyScopeLevel) Valid() bool {
	switch e {
	case ResolveSecretsBodyScopeLevelBranch:
		return true
	case ResolveSecretsBodyScopeLevelEnvironment:
		return true
	case ResolveSecretsBodyScopeLevelOrg:
		return true
	case ResolveSecretsBodyScopeLevelSource:
		return true
	default:
		return false
	}
...
// Defines values for ReadSecretParamsScopeLevel.
const (
	ReadSecretParamsScopeLevelBranch      ReadSecretParamsScopeLevel = "branch"
	ReadSecretParamsScopeLevelEnvironment ReadSecretParamsScopeLevel = "environment"
	ReadSecretParamsScopeLevelOrg         ReadSecretParamsScopeLevel = "org"
	ReadSecretParamsScopeLevelSource      ReadSecretParamsScopeLevel = "source"
)

// Valid indicates whether the value is a known member of the ReadSecretParamsScopeLevel enum.
func (e ReadSecretParamsScopeLevel) Valid() bool {
	switch e {
	case ReadSecretParamsScopeLevelBranch:
		return true
	case ReadSecretParamsScopeLevelEnvironment:
		return true
	case ReadSecretParamsScopeLevelOrg:
		return true
	case ReadSecretParamsScopeLevelSource:
		return true
	default:
		return false
	}
...
const (
	DeleteVariableParamsScopeLevelBranch      DeleteVariableParamsScopeLevel = "branch"
	DeleteVariableParamsScopeLevelEnvironment DeleteVariableParamsScopeLevel = "environment"
	DeleteVariableParamsScopeLevelOrg         DeleteVariableParamsScopeLevel = "org"
	DeleteVariableParamsScopeLevelSource      DeleteVariableParamsScopeLevel = "source"
)
...
func (e DeleteVariableParamsScopeLevel) Valid() bool {
	switch e {
	case DeleteVariableParamsScopeLevelBranch:
		return true
	case DeleteVariableParamsScopeLevelEnvironment:
		return true
	case DeleteVariableParamsScopeLevelOrg:
		return true
	case DeleteVariableParamsScopeLevelSource:
		return true
	default:
		return false
	}
...
// Defines values for ReadVariableParamsScopeLevel.
const (
	ReadVariableParamsScopeLevelBranch      ReadVariableParamsScopeLevel = "branch"
	ReadVariableParamsScopeLevelEnvironment ReadVariableParamsScopeLevel = "environment"
	ReadVariableParamsScopeLevelOrg         ReadVariableParamsScopeLevel = "org"
	ReadVariableParamsScopeLevelSource      ReadVariableParamsScopeLevel = "source"
)

// Valid indicates whether the value is a known member of the ReadVariableParamsScopeLevel enum.
func (e ReadVariableParamsScopeLevel) Valid() bool {
	switch e {
	case ReadVariableParamsScopeLevelBranch:
		return true
	case ReadVariableParamsScopeLevelEnvironment:
		return true
	case ReadVariableParamsScopeLevelOrg:
		return true
	case ReadVariableParamsScopeLevelSource:
		return true
	default:
		return false
	}
...
// ResolveSecretsBody defines model for ResolveSecretsBody.
type ResolveSecretsBody struct {
	...
	ScopeLevel *ResolveSecretsBodyScopeLevel `json:"scope_level,omitempty"`
	SourceId   *string                       `json:"source_id,omitempty"`
}

// ResolveSecretsBodyScopeLevel defines model for ResolveSecretsBody.ScopeLevel.
type ResolveSecretsBodyScopeLevel string

// ResolvedSecretsDTO defines model for ResolvedSecretsDTO.
...
// ReadSecretParams defines parameters for ReadSecret.
type ReadSecretParams struct {
	ScopeLevel *ReadSecretParamsScopeLevel `form:"scope_level,omitempty" json:"scope_level,omitempty"`
	SourceId   *string                     `form:"source_id,omitempty" json:"source_id,omitempty"`
	EnvId      *string                     `form:"env_id,omitempty" json:"env_id,omitempty"`
	Branch     *string                     `form:"branch,omitempty" json:"branch,omitempty"`
}

// ReadSecretParamsScopeLevel defines parameters for ReadSecret.
type ReadSecretParamsScopeLevel string
...
// ReadVariableParams defines parameters for ReadVariable.
type ReadVariableParams struct {
	ScopeLevel *ReadVariableParamsScopeLevel `form:"scope_level,omitempty" json:"scope_level,omitempty"`
	SourceId   *string                       `form:"source_id,omitempty" json:"source_id,omitempty"`
	EnvId      *string                       `form:"env_id,omitempty" json:"env_id,omitempty"`
	Branch     *string                       `form:"branch,omitempty" json:"branch,omitempty"`
}

// ReadVariableParamsScopeLevel defines parameters for ReadVariable.
type ReadVariableParamsScopeLevel string
...
// ResolveSecretsJSONRequestBody defines body for ResolveSecrets for application/json ContentType.
type ResolveSecretsJSONRequestBody = ResolveSecretsBody
...
type ClientInterface interface {
	...
	// ReadSecret request
	ReadSecret(ctx context.Context, name string, params *ReadSecretParams, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// ResolveSecretsWithBody request with any body
	ResolveSecretsWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	ResolveSecrets(ctx context.Context, body ResolveSecretsJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	ReadVariable(ctx context.Context, name string, params *ReadVariableParams, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) ReadSecret(ctx context.Context, name string, params *ReadSecretParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewReadSecretRequest(c.Server, name, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) ResolveSecretsWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewResolveSecretsRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) ResolveSecrets(ctx context.Context, body ResolveSecretsJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewResolveSecretsRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) ReadVariable(ctx context.Context, name string, params *ReadVariableParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewReadVariableRequest(c.Server, name, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewReadSecretRequest(server string, name string, params *ReadSecretParams) (*http.Request, error) {
	var err error
...
// NewResolveSecretsRequest calls the generic ResolveSecrets builder with application/json body
func NewResolveSecretsRequest(server string, body ResolveSecretsJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewResolveSecretsRequestWithBody(server, "application/json", bodyReader)
}

// NewResolveSecretsRequestWithBody generates requests for ResolveSecrets with any type of body
func NewResolveSecretsRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/v1/secrets:resolve")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewReadVariableRequest(server string, name string, params *ReadVariableParams) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	ReadSecretWithResponse(ctx context.Context, name string, params *ReadSecretParams, reqEditors ...RequestEditorFn) (*ReadSecretResponse, error)
	...
	// ResolveSecretsWithBodyWithResponse request with any body
	ResolveSecretsWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*ResolveSecretsResponse, error)

	ResolveSecretsWithResponse(ctx context.Context, body ResolveSecretsJSONRequestBody, reqEditors ...RequestEditorFn) (*ResolveSecretsResponse, error)
	...
	ReadVariableWithResponse(ctx context.Context, name string, params *ReadVariableParams, reqEditors ...RequestEditorFn) (*ReadVariableResponse, error)
...
type ResolveSecretsResponse struct {
	Body                          []byte
	HTTPResponse                  *http.Response
	JSON200                       *ResolvedSecretsDTO
	ApplicationproblemJSONDefault *ErrorModel
}

// Status returns HTTPResponse.Status
func (r ResolveSecretsResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r ResolveSecretsResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
func (c *ClientWithResponses) ReadSecretWithResponse(ctx context.Context, name string, params *ReadSecretParams, reqEditors ...RequestEditorFn) (*ReadSecretResponse, error) {
	rsp, err := c.ReadSecret(ctx, name, params, reqEditors...)
	if err != nil {
		return nil, err
	}
...
// ResolveSecretsWithBodyWithResponse request with arbitrary body returning *ResolveSecretsResponse
func (c *ClientWithResponses) ResolveSecretsWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*ResolveSecretsResponse, error) {
	rsp, err := c.ResolveSecretsWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseResolveSecretsResponse(rsp)
}

func (c *ClientWithResponses) ResolveSecretsWithResponse(ctx context.Context, body ResolveSecretsJSONRequestBody, reqEditors ...RequestEditorFn) (*ResolveSecretsResponse, error) {
	rsp, err := c.ResolveSecrets(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseResolveSecretsResponse(rsp)
...
func (c *ClientWithResponses) ReadVariableWithResponse(ctx context.Context, name string, params *ReadVariableParams, reqEditors ...RequestEditorFn) (*ReadVariableResponse, error) {
	rsp, err := c.ReadVariable(ctx, name, params, reqEditors...)
	if err != nil {
		return nil, err
	}
...
// ParseResolveSecretsResponse parses an HTTP response from a ResolveSecretsWithResponse call
func ParseResolveSecretsResponse(rsp *http.Response) (*ResolveSecretsResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &ResolveSecretsResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
