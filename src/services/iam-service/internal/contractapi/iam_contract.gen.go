...
// Code generated by //src/smithy/cmd/ir-go from iam-public. DO NOT EDIT.
...
var ListOrganizationsOperation = OperationDescriptor{
...
var GetOrganizationOperation = OperationDescriptor{
...
var UpdateOrganizationOperation = OperationDescriptor{
...
var ListMembersOperation = OperationDescriptor{
...
var GetMemberOperation = OperationDescriptor{
...
var UpdateMemberRoleOperation = OperationDescriptor{
...
func RegisterPublic(api huma.API, runtime Runtime, handlers PublicHandlers) {
	if runtime == nil {
		panic("contractapi: runtime is required")
	}
	if handlers == nil {
		panic("contractapi: public handlers are required")
	}
	registerListOrganizations(api, runtime, handlers.ListOrganizations)
	registerGetOrganization(api, runtime, handlers.GetOrganization)
	registerUpdateOrganization(api, runtime, handlers.UpdateOrganization)
	registerListMembers(api, runtime, handlers.ListMembers)
	registerGetMember(api, runtime, handlers.GetMember)
	registerUpdateMemberRole(api, runtime, handlers.UpdateMemberRole)
}

func registerListOrganizations(api huma.API, runtime Runtime, handler func(context.Context, *ListOrganizationsInput) (*ListOrganizationsOutput, error)) {
	op := runtime.PrepareOperation(ListOrganizationsOperation, huma.Operation{OperationID: ListOrganizationsOperation.OperationID, Method: ListOrganizationsOperation.Method, Path: ListOrganizationsOperation.Path, Summary: "List organizations", DefaultStatus: ListOrganizationsOperation.DefaultStatus})
	huma.Register(api, op, func(ctx context.Context, input *ListOrganizationsInput) (*ListOrganizationsOutput, error) {
		identity, err := runtime.BeforeOperation(ctx, ListOrganizationsOperation, input)
		if err != nil {
			runtime.AfterOperation(ctx, ListOrganizationsOperation, identity, input, nil, err)
			return nil, err
		}
		output, err := handler(ctx, input)
		runtime.AfterOperation(ctx, ListOrganizationsOperation, identity, input, output, err)
		return output, err
	})
}

func registerGetOrganization(api huma.API, runtime Runtime, handler func(context.Context, *GetOrganizationInput) (*GetOrganizationOutput, error)) {
	op := runtime.PrepareOperation(GetOrganizationOperation, huma.Operation{OperationID: GetOrganizationOperation.OperationID, Method: GetOrganizationOperation.Method, Path: GetOrganizationOperation.Path, Summary: "Get organization", DefaultStatus: GetOrganizationOperation.DefaultStatus})
	huma.Register(api, op, func(ctx context.Context, input *GetOrganizationInput) (*GetOrganizationOutput, error) {
		identity, err := runtime.BeforeOperation(ctx, GetOrganizationOperation, input)
		if err != nil {
			runtime.AfterOperation(ctx, GetOrganizationOperation, identity, input, nil, err)
			return nil, err
		}
		output, err := handler(ctx, input)
		runtime.AfterOperation(ctx, GetOrganizationOperation, identity, input, output, err)
		return output, err
	})
}

func registerUpdateOrganization(api huma.API, runtime Runtime, handler func(context.Context, *UpdateOrganizationInput) (*UpdateOrganizationOutput, error)) {
	op := runtime.PrepareOperation(UpdateOrganizationOperation, huma.Operation{OperationID: UpdateOrganizationOperation.OperationID, Method: UpdateOrganizationOperation.Method, Path: UpdateOrganizationOperation.Path, Summary: "Update organization", DefaultStatus: UpdateOrganizationOperation.DefaultStatus})
	huma.Register(api, op, func(ctx context.Context, input *UpdateOrganizationInput) (*UpdateOrganizationOutput, error) {
		identity, err := runtime.BeforeOperation(ctx, UpdateOrganizationOperation, input)
		if err != nil {
			runtime.AfterOperation(ctx, UpdateOrganizationOperation, identity, input, nil, err)
			return nil, err
		}
		output, err := handler(ctx, input)
		runtime.AfterOperation(ctx, UpdateOrganizationOperation, identity, input, output, err)
		return output, err
	})
}

func registerListMembers(api huma.API, runtime Runtime, handler func(context.Context, *ListMembersInput) (*ListMembersOutput, error)) {
	op := runtime.PrepareOperation(ListMembersOperation, huma.Operation{OperationID: ListMembersOperation.OperationID, Method: ListMembersOperation.Method, Path: ListMembersOperation.Path, Summary: "List members", DefaultStatus: ListMembersOperation.DefaultStatus})
	huma.Register(api, op, func(ctx context.Context, input *ListMembersInput) (*ListMembersOutput, error) {
		identity, err := runtime.BeforeOperation(ctx, ListMembersOperation, input)
		if err != nil {
			runtime.AfterOperation(ctx, ListMembersOperation, identity, input, nil, err)
			return nil, err
		}
		output, err := handler(ctx, input)
		runtime.AfterOperation(ctx, ListMembersOperation, identity, input, output, err)
		return output, err
	})
}

func registerGetMember(api huma.API, runtime Runtime, handler func(context.Context, *GetMemberInput) (*GetMemberOutput, error)) {
	op := runtime.PrepareOperation(GetMemberOperation, huma.Operation{OperationID: GetMemberOperation.OperationID, Method: GetMemberOperation.Method, Path: GetMemberOperation.Path, Summary: "Get member", DefaultStatus: GetMemberOperation.DefaultStatus})
	huma.Register(api, op, func(ctx context.Context, input *GetMemberInput) (*GetMemberOutput, error) {
		identity, err := runtime.BeforeOperation(ctx, GetMemberOperation, input)
		if err != nil {
			runtime.AfterOperation(ctx, GetMemberOperation, identity, input, nil, err)
			return nil, err
		}
		output, err := handler(ctx, input)
		runtime.AfterOperation(ctx, GetMemberOperation, identity, input, output, err)
		return output, err
	})
}

func registerUpdateMemberRole(api huma.API, runtime Runtime, handler func(context.Context, *UpdateMemberRoleInput) (*UpdateMemberRoleOutput, error)) {
	op := runtime.PrepareOperation(UpdateMemberRoleOperation, huma.Operation{OperationID: UpdateMemberRoleOperation.OperationID, Method: UpdateMemberRoleOperation.Method, Path: UpdateMemberRoleOperation.Path, Summary: "Update member role", DefaultStatus: UpdateMemberRoleOperation.DefaultStatus})
	huma.Register(api, op, func(ctx context.Context, input *UpdateMemberRoleInput) (*UpdateMemberRoleOutput, error) {
		identity, err := runtime.BeforeOperation(ctx, UpdateMemberRoleOperation, input)
		if err != nil {
			runtime.AfterOperation(ctx, UpdateMemberRoleOperation, identity, input, nil, err)
			return nil, err
		}
		output, err := handler(ctx, input)
		runtime.AfterOperation(ctx, UpdateMemberRoleOperation, identity, input, output, err)
		return output, err
	})
}
