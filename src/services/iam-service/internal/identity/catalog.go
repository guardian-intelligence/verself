...
const (
	...
	PermissionOrganizationSlugCheck         = "iam:organization_slug:check"
	...
	Services: []ServiceOperations{
		smithyIAMServiceOperations(),
		{
			...
			Operations: []Operation{
				...
				{OperationID: "list-caches", Permission: PermissionSandboxCacheRead, Resource: "cache", Action: "list", OrgScope: "token_org_id"},
				...
				{OperationID: "delete-cache-path", Permission: PermissionSandboxCacheWrite, Resource: "cache", Action: "delete", OrgScope: "token_org_id"},
