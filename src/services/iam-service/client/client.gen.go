...
// IAMResolveOrganizationResponse defines model for IAMResolveOrganizationResponse.
...
// IAMUpdateHumanProfileResponse defines model for IAMUpdateHumanProfileResponse.
...
type UpdateHumanProfileJSONRequestBody = IAMUpdateHumanProfileRequest
...
type ResolveOrganizationHTTPResponse struct {
	Body                          []byte
	HTTPResponse                  *http.Response
	JSON200                       *IAMResolveOrganizationResponse
	ApplicationproblemJSONDefault *ErrorModel
}
...
type UpdateHumanProfileHTTPResponse struct {
	Body                          []byte
	HTTPResponse                  *http.Response
	JSON200                       *IAMUpdateHumanProfileResponse
	ApplicationproblemJSONDefault *ErrorModel
}
...
func ParseResolveOrganizationHTTPResponse(rsp *http.Response) (*ResolveOrganizationHTTPResponse, error) {
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest IAMResolveOrganizationResponse
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
...
func ParseUpdateHumanProfileHTTPResponse(rsp *http.Response) (*UpdateHumanProfileHTTPResponse, error) {
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest IAMUpdateHumanProfileResponse
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
