  ...
  group "github-integration-service" {
    ...
    task "github-integration-service" {
      ...
      env {
        ...
        GITHUB_APP_SLUG = "__VERSELF_GITHUB_APP_SLUG__"
        GITHUB_MAX_DELIVERY_TRIES = "8"
        GITHUB_OAUTH_AUTHORIZE_URL = "https://github.com/login/oauth/authorize"
        GITHUB_OAUTH_CLIENT_ID = "__VERSELF_GITHUB_OAUTH_CLIENT_ID__"
        GITHUB_OAUTH_REDIRECT_URL = "__VERSELF_GITHUB_OAUTH_REDIRECT_URL__"
        GITHUB_OAUTH_TOKEN_URL = "https://github.com/login/oauth/access_token"
        GITHUB_RUNNER_CLASS_PREFIX = "__VERSELF_GITHUB_RUNNER_CLASS_PREFIX__"
