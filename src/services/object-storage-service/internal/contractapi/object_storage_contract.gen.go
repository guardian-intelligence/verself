...
// Code generated by //src/smithy/cmd/ir-go from object-storage-public. DO NOT EDIT.
...
var ListObjectStorageBuckets = Operation[EmptyInput, ListObjectStorageBucketsOutput]{
	Descriptor: OperationDescriptor{
		...
		RequestPayload:      PayloadDescriptor{},
		ResponsePayload:     PayloadDescriptor{Member: "buckets", Target: "verself.objectstorage.v1#Buckets", Kind: "list", MediaType: "", Streaming: false, Sensitive: false, Required: true},
		ResponseHeaders:     []HeaderDescriptor{},
...
var ListObjectStorageBucketAliases = Operation[BucketPathInput, ListObjectStorageBucketAliasesOutput]{
	Descriptor: OperationDescriptor{
		...
		RequestBodyMaxBytes: 0,
		RequestPayload:      PayloadDescriptor{},
		ResponsePayload:     PayloadDescriptor{Member: "aliases", Target: "verself.objectstorage.v1#BucketAliases", Kind: "list", MediaType: "", Streaming: false, Sensitive: false, Required: true},
		ResponseHeaders:     []HeaderDescriptor{},
		Idempotency:         IdempotencyDescriptor{Policy: "", Header: "", Member: ""},
...
var ListObjectStorageCredentials = Operation[BucketPathInput, ListObjectStorageCredentialsOutput]{
	Descriptor: OperationDescriptor{
		...
		RequestBodyMaxBytes: 0,
		RequestPayload:      PayloadDescriptor{},
		ResponsePayload:     PayloadDescriptor{Member: "credentials", Target: "verself.objectstorage.v1#ObjectStorageCredentials", Kind: "list", MediaType: "", Streaming: false, Sensitive: false, Required: true},
		ResponseHeaders:     []HeaderDescriptor{},
		Idempotency:         IdempotencyDescriptor{Policy: "", Header: "", Member: ""},
