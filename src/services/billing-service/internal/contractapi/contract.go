...
var ListBillingDocuments = Operation[DocumentsQueryInput, ListBillingDocumentsOutput]{
	Descriptor: OperationDescriptor{
		...
		Readonly:            true,
		Paginated:           false,
		Identity:            IdentityDescriptor{Mode: "bearer", Audience: "billing-service", Principals: []string{"browser", "cli", "workload"}},
...
var CreateBillingCheckout = Operation[CheckoutInput, BillingURLResponseOutput]{
	Descriptor: OperationDescriptor{
		...
		Readonly:            false,
		Paginated:           false,
		Identity:            IdentityDescriptor{Mode: "bearer", Audience: "billing-service", Principals: []string{"browser", "cli"}},
