...
// Code generated by //src/smithy/cmd/ir-go from sandbox-public. DO NOT EDIT.
...
var ListGithubInstallations = Operation[EmptyInput, ListGithubInstallationsOutput]{
	Descriptor: OperationDescriptor{
		...
		RequestBodyMaxBytes: 0,
		RequestPayload:      PayloadDescriptor{},
		ResponsePayload:     PayloadDescriptor{Member: "installations", Target: "verself.sandbox.v1#GitHubInstallations", Kind: "list", MediaType: "", Streaming: false, Sensitive: false, Required: true},
		ResponseHeaders:     []HeaderDescriptor{},
		Idempotency:         IdempotencyDescriptor{Policy: "", Header: "", Member: ""},
