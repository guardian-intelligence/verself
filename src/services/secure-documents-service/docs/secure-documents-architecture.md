...
- `src/sdks/domain-transfer-objects/docs/wire-contracts.md` for the wire-shape conventions and generated-client patterns the public surface must obey.
...
```
src/services/secure-documents-service/
├── BUILD.bazel
├── pyproject.toml
├── alembic.ini
├── migrations/versions/
...
One database, `secure_documents`. Migrations in `src/services/secure-documents-service/migrations/versions/`.
