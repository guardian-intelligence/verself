...
const ServiceName = "mailbox-service"
...
type MailboxForwarderStatusView struct {
	...
	Mailbox                 ForwarderMailbox    `json:"mailbox"`
	...
	LastForwardedEmailID    *ForwardedEmailId   `json:"last_forwarded_email_id,omitempty"`
}
...
type MailboxSyncStatusView struct {
	...
	StalwartBaseURL MailboxServiceURL           `json:"stalwart_base_url"`
	PublicBaseURL   MailboxServiceURL           `json:"public_base_url"`
	Forwarder       MailboxForwarderStatusView  `json:"forwarder"`
