...
type ProjectEvent struct {
	...
	// EnvironmentResourceName Globally unique Verself resource name for the environment when present.
	EnvironmentResourceName *string             `json:"environmentResourceName,omitempty"`
...
// ListProjectEventsServiceParams defines parameters for ListProjectEventsService.
type ListProjectEventsServiceParams struct {
...
type ClientInterface interface {
	...
	// ListProjectEventsService request
	ListProjectEventsService(ctx context.Context, params *ListProjectEventsServiceParams, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) ListProjectEventsService(ctx context.Context, params *ListProjectEventsServiceParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewListProjectEventsServiceRequest(c.Server, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewResolveProjectEnvironmentRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/service/v1/project-environments/resolve")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewListProjectEventsServiceRequest generates requests for ListProjectEventsService
func NewListProjectEventsServiceRequest(server string, params *ListProjectEventsServiceParams) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/service/v1/project-events")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewResolveProjectRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/service/v1/projects/resolve")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// ListProjectEventsServiceWithResponse request
	ListProjectEventsServiceWithResponse(ctx context.Context, params *ListProjectEventsServiceParams, reqEditors ...RequestEditorFn) (*ListProjectEventsServiceHTTPResponse, error)
...
type ListProjectEventsServiceHTTPResponse struct {
	Body                          []byte
	HTTPResponse                  *http.Response
...
// Status returns HTTPResponse.Status
func (r ListProjectEventsServiceHTTPResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r ListProjectEventsServiceHTTPResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// ListProjectEventsServiceWithResponse request returning *ListProjectEventsServiceHTTPResponse
func (c *ClientWithResponses) ListProjectEventsServiceWithResponse(ctx context.Context, params *ListProjectEventsServiceParams, reqEditors ...RequestEditorFn) (*ListProjectEventsServiceHTTPResponse, error) {
	rsp, err := c.ListProjectEventsService(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseListProjectEventsServiceHTTPResponse(rsp)
}
...
// ParseListProjectEventsServiceHTTPResponse parses an HTTP response from a ListProjectEventsServiceWithResponse call
func ParseListProjectEventsServiceHTTPResponse(rsp *http.Response) (*ListProjectEventsServiceHTTPResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &ListProjectEventsServiceHTTPResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
