...
var CreateSourceGitCredential = Operation[CreateSourceGitCredentialInput, GitCredentialOutput]{
	Descriptor: OperationDescriptor{
		...
		Readonly:            false,
		Paginated:           false,
		Identity:            IdentityDescriptor{Mode: "bearer", Audience: "source-code-hosting-service", Principals: []string{"browser", "cli"}},
...
var ListSourceRepositories = Operation[ListSourceRepositoriesInput, ListSourceRepositoriesOutput]{
	Descriptor: OperationDescriptor{
		...
		Readonly:            true,
		Paginated:           false,
		Identity:            IdentityDescriptor{Mode: "bearer", Audience: "source-code-hosting-service", Principals: []string{"browser", "cli", "workload"}},
