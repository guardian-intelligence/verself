...
func TestProjectsCreateUsesBearerAndIdempotency(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = w.Write([]byte(`{"project_id":"11111111-1111-1111-1111-111111111111","org_id":"org_00000000000000000000000000","slug":"api","display_name":"API","description":"Core API","state":"active","version":"1","created_by":"user","updated_by":"user","created_at":"2026-05-06T00:00:00Z","updated_at":"2026-05-06T00:00:00Z"}`))
	}))
	defer server.Close()
...
func TestProjectsListParsesPage(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("Content-Type", "application/json")
		_, _ = w.Write([]byte(`{"next_cursor":"cursor-1","projects":[{"project_id":"11111111-1111-1111-1111-111111111111","org_id":"org_00000000000000000000000000","slug":"api","display_name":"API","description":"","state":"active","version":"1","created_by":"user","updated_by":"user","created_at":"2026-05-06T00:00:00Z","updated_at":"2026-05-06T00:00:00Z"}]}`))
	}))
	defer server.Close()
...
func TestProjectsMutationsUseVersionAndIdempotency(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case r.Method == http.MethodPatch && r.URL.Path == "/api/v1/projects/"+projectID:
			...
			_, _ = w.Write([]byte(`{"project_id":"11111111-1111-1111-1111-111111111111","org_id":"org_00000000000000000000000000","slug":"api-core","display_name":"API Core","description":"Core","state":"active","version":"2","created_by":"user","updated_by":"user","created_at":"2026-05-06T00:00:00Z","updated_at":"2026-05-06T00:00:00Z"}`))
		case r.Method == http.MethodPost && r.URL.Path == "/api/v1/projects/"+projectID+"/archive":
			...
			_, _ = w.Write([]byte(`{"project_id":"11111111-1111-1111-1111-111111111111","org_id":"org_00000000000000000000000000","slug":"api-core","display_name":"API Core","description":"Core","state":"archived","version":"3","created_by":"user","updated_by":"user","created_at":"2026-05-06T00:00:00Z","updated_at":"2026-05-06T00:00:00Z"}`))
		case r.Method == http.MethodPost && r.URL.Path == "/api/v1/projects/"+projectID+"/restore":
			...
			_, _ = w.Write([]byte(`{"project_id":"11111111-1111-1111-1111-111111111111","org_id":"org_00000000000000000000000000","slug":"api-core","display_name":"API Core","description":"Core","state":"active","version":"4","created_by":"user","updated_by":"user","created_at":"2026-05-06T00:00:00Z","updated_at":"2026-05-06T00:00:00Z"}`))
		default:
			t.Fatalf("unexpected request %s %s", r.Method, r.URL.Path)
		}
	}))
...
func TestProjectEnvironmentsUsePublicAPI(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		environmentJSON := `{"environment_id":"22222222-2222-2222-2222-222222222222","project_id":"11111111-1111-1111-1111-111111111111","org_id":"org_00000000000000000000000000","slug":"staging","display_name":"Staging","kind":"custom","state":"active","version":"1","created_by":"user","updated_by":"user","created_at":"2026-05-06T00:00:00Z","updated_at":"2026-05-06T00:00:00Z"}`
		switch {
