...
func TestSandboxRunsAndSchedulesUsePublicAPI(t *testing.T) {
	...
	runJSON := `{"execution_id":"` + executionID + `","run_id":"` + runID + `","org_id":"org_00000000000000000000000000","actor_id":"user_1","product_id":"sandbox-ci","kind":"ci","status":"succeeded","source_kind":"github","workload_kind":"github_actions","runner_class":"linux-2vcpu","latest_attempt":{"attempt_id":"attempt_1","attempt_seq":1,"state":"succeeded","trace_id":"trace_1","created_at":"2026-05-06T00:00:00Z","updated_at":"2026-05-06T00:01:00Z"},"created_at":"2026-05-06T00:00:00Z","updated_at":"2026-05-06T00:01:00Z"}`
