...
func main() {
	...
	flag.BoolVar(&check, "check", false, "verify committed internal spec is up to date")
	flag.Parse()
	...
	switch format {
	case "3.0":
		data, err = api.NewInternalAPIYAML("1.0.0", "https://127.0.0.1:4262", true)
	case "3.1":
		data, err = api.NewInternalAPIYAML("1.0.0", "https://127.0.0.1:4262", false)
	default:
