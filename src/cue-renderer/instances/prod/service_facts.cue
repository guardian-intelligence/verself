			...
			units: [
				{
					...
					requires_spiffe_sock: true
					after: ["verself-firewall.target", "network.target", "postgresql.service", "clickhouse-server.service", "garage@0.service", "garage@1.service", "garage@2.service", "spire-agent.service"]
