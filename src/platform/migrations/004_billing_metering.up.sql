CREATE TABLE IF NOT EXISTS forge_metal.metering (
    ...
    bucket_free_tier_units    Map(LowCardinality(String), UInt64)  CODEC(ZSTD(3)),
    bucket_subscription_units Map(LowCardinality(String), UInt64)  CODEC(ZSTD(3)),
    bucket_purchase_units     Map(LowCardinality(String), UInt64)  CODEC(ZSTD(3)),
