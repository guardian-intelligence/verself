...
Declared source: src/host-configuration/ansible/group_vars/all/generated/endpoints.yml
...
ENDPOINTS_YAML = REPO_ROOT / "src/host-configuration/ansible/group_vars/all/generated/endpoints.yml"
INVENTORY = REPO_ROOT / f"src/host-configuration/ansible/inventory/{SITE}.ini"
...
def render_nftables(report: Report) -> str:
    ...
    The real firewall lives under src/host-configuration/ansible/rendered/etc/nftables.d/.
    ...
    lines.append("# Derived from src/host-configuration/ansible/group_vars/all/generated/endpoints.yml")
