...
import (
	...
	"github.com/verself/projects-service/internal/api"
)
...
func main() {
	...
	switch format {
	case "3.0":
		data, err = api.OpenAPIDowngradeYAML("1.0.0", "https://projects.api.verself.sh")
	case "3.1":
		data, err = api.OpenAPIYAML("1.0.0", "https://projects.api.verself.sh")
	default:
