import { deriveAuthIssuerURL, deriveProductBaseURL, deriveSeededEmail } from "@verself/web-env";
...
export const env = {
  ...
  // test user via the Zitadel Management API. If not set, provide credentials
  // for an existing test user.
