...
class SignupIntentStartParams(TypedDict, total=False):
    email: str
    organization_display_name: Annotated[str, PropertyInfo(alias="organizationDisplayName")]
    organization_slug: Annotated[str, PropertyInfo(alias="organizationSlug")]
