...
- For local app development, cd into the app package and run `vp dev`. See `src/viteplus-monorepo/README.md`.
...
- Deploy frontend changes to prod fearlessly (e.g. `guardian fly prod`) -- I can't see your dev server.
