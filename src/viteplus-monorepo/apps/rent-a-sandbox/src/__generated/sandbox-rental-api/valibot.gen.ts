...
export const vBalanceOutputBody = v.strictObject({
...
export const vBillingWindow = v.strictObject({
    actual_seconds: v.optional(v.pipe(v.union([
        v.number(),
        v.string(),
        v.bigint()
    ]), v.transform(x => BigInt(x)), v.minValue(BigInt('-9223372036854775808'), 'Invalid value: Expected int64 to be >= -9223372036854775808'), v.maxValue(BigInt('9223372036854775807'), 'Invalid value: Expected int64 to be <= 9223372036854775807'))),
...
export const vSubscriptionJson = v.strictObject({
    ...
    overage_cap_units: v.optional(v.pipe(v.union([
        v.number(),
        v.string(),
        v.bigint()
    ]), v.transform(x => BigInt(x)), v.minValue(BigInt('-9223372036854775808'), 'Invalid value: Expected int64 to be >= -9223372036854775808'), v.maxValue(BigInt('9223372036854775807'), 'Invalid value: Expected int64 to be <= 9223372036854775807'))),
 ...
 * OK
 */
export const vGetBillingBalanceResponse = vBalanceOutputBody;
 ...
 * OK
 */
export const vListBillingGrantsResponse = vGrantsOutputBody;
 ...
 * OK
 */
export const vListBillingSubscriptionsResponse = vSubscriptionsOutputBody;
