...
import type { DegradedReason, FirstLightFrame } from "../types";
...
export function FirstLightCanvas({ active, frame, onDegraded }: FirstLightCanvasProps) {
  ...
  useEffect(() => {
    ...
    try {
      renderer = new WebGLRenderer({
        ...
        preserveDrawingBuffer: new URLSearchParams(window.location.search).has("visual-test"),
      });
    } catch (error) {
