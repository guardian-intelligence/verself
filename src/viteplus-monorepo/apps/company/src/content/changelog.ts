...
export const changelog: readonly ChangelogEntry[] = [
  {
    ...
    body: "The public IA collapses to a single Solution — Verself Platform — and the /products route is retired. Verself Platform is the bundle a customer buys; services, the web console, CLIs, and SDKs are its products and are described on Verself's own surfaces. The /trust and /legal routes are retired on anveio.com; terms, privacy, the SLA, subprocessors, data retention, and security disclosures live with Verself at platform.anveio.com/policy where the data is actually processed. The marketing site keeps its company-level surfaces: Letters, Design, Press, Careers, Changelog, Contact.",
  },
  {
    date: "2026-04-19",
    title: "anveio.com moves to apps/company",
    body: "The Guardian company site gets its own TanStack Start app, separate from the Verself platform console. The Verself console moves to platform.anveio.com and will eventually resolve at console.<domain>.",
  },
];
