...
const ITEMS: readonly NewsroomItem[] = [
  ...
  },
  {
    ...
    deck: "The editorial register shipped with a single seeded essay and an RSS feed. Letters is the place where we explain the why.",
    date: "12 April 2026",
    ...
    body: [
      ...
      "The first letter is out today. An RSS feed lives at /letters/rss for readers who would rather not depend on a homepage visit.",
    ],
