...
export const CAREERS_META = {
  ...
  description:
    "Guardian is small on purpose. We hire slowly, in person, and for work that compounds.",
} as const;
...
export const careers = {
  ...
  hero: "We hire slowly.",
  paragraphs: [
    "Guardian is small on purpose. The thesis of the company is that a small number of people, paired with modern tooling, can ship what used to require a floor of engineers. We staff to that thesis.",
