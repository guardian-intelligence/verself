...
// openapi/openapi-3.1.yaml. Keeping them checked in means the public docs
// build never reaches outside the monorepo rsync during Ansible deploys.
import * as v from "valibot";
import { parse as parseYaml } from "yaml";

import sandboxRentalYaml from "../__generated/sandbox-rental-api/openapi-3.1.yaml?raw";
import identityYaml from "../__generated/identity-api/openapi-3.1.yaml?raw";
import mailboxYaml from "../__generated/mailbox-api/openapi-3.1.yaml?raw";
import billingYaml from "../__generated/billing-api/openapi-3.1.yaml?raw";
