  ...
  return (
    <div className="mx-auto w-full max-w-5xl px-4 py-16 md:px-6 md:py-24">
      ...
      <p className="mt-4 max-w-2xl text-base leading-7 text-muted-foreground md:text-lg">
        Documentation, API references, and architecture notes for the Forge Metal platform —
        sandbox runtime, identity, billing, and mailbox services running on a single operator-owned
        bare-metal node.
      </p>
      ...
      <div className="mt-10 grid gap-3 md:grid-cols-3">
        <LandingCard
          to="/docs"
          title="Docs"
          description="Start here. Architecture, deployment topology, and service-by-service explainers."
          icon={BookOpen}
        />
        <LandingCard
          to="/docs/reference"
