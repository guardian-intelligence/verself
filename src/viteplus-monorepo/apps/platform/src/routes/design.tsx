...
export const Route = createFileRoute("/design")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "/design/assets/og.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "/design/assets/og.png" },
    ],
  ...
  return (
    <header className="mb-16 flex flex-col gap-4">
      ...
      >
        ...
        iron chip on Paper, and a circular ink emboss on Flare. This page specifies the mark, the
        type, the colour, and how they appear in the surfaces the company actually ships:
        marketing, editorial, product, and external.
      </p>
    </header>
  );
}
