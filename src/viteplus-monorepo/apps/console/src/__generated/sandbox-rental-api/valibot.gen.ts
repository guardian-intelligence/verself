...
export const vSandboxAttemptRecord = v.strictObject({
    ...
    attempt_seq: v.pipe(v.union([
        ...
        v.string(),
        v.bigint()
    ]), v.transform(x => BigInt(x)), v.minValue(BigInt(0)), v.maxValue(BigInt(9007199254740991))),
    billing_job_id: v.optional(v.pipe(v.union([
        v.number(),
        v.string(),
        v.bigint()
    ]), v.transform(x => BigInt(x)), v.minValue(BigInt(0)), v.maxValue(BigInt(9007199254740991)))),
    block_read_bytes: v.optional(v.pipe(v.union([
        v.number(),
        v.string(),
        v.bigint()
    ]), v.transform(x => BigInt(x)), v.minValue(BigInt(0)), v.maxValue(BigInt(9007199254740991)))),
    block_write_bytes: v.optional(v.pipe(v.union([
        v.number(),
        v.string(),
        v.bigint()
    ]), v.transform(x => BigInt(x)), v.minValue(BigInt(0)), v.maxValue(BigInt(9007199254740991)))),
    boot_time_us: v.optional(v.pipe(v.union([
        v.number(),
        v.string(),
        v.bigint()
    ]), v.transform(x => BigInt(x)), v.minValue(BigInt(0)), v.maxValue(BigInt(9007199254740991)))),
    ...
    exit_code: v.optional(v.pipe(v.union([
        ...
        v.string(),
        v.bigint()
    ]), v.transform(x => BigInt(x)), v.minValue(BigInt(0)), v.maxValue(BigInt(255)))),
    failure_reason: v.optional(v.string()),
    lease_id: v.optional(v.string()),
    net_rx_bytes: v.optional(v.pipe(v.union([
        v.number(),
        v.string(),
        v.bigint()
    ]), v.transform(x => BigInt(x)), v.minValue(BigInt(0)), v.maxValue(BigInt(9007199254740991)))),
    net_tx_bytes: v.optional(v.pipe(v.union([
        v.number(),
        v.string(),
        v.bigint()
    ]), v.transform(x => BigInt(x)), v.minValue(BigInt(0)), v.maxValue(BigInt(9007199254740991)))),
    rootfs_provisioned_bytes: v.optional(v.pipe(v.union([
        v.number(),
        v.string(),
        v.bigint()
    ]), v.transform(x => BigInt(x)), v.minValue(BigInt(0)), v.maxValue(BigInt(9007199254740991)))),
    ...
    vcpu_exit_count: v.optional(v.pipe(v.union([
        v.number(),
        v.string(),
        v.bigint()
    ]), v.transform(x => BigInt(x)), v.minValue(BigInt(0)), v.maxValue(BigInt(9007199254740991)))),
...
export const vSandboxBillingCheckoutRequest = v.strictObject({
    ...
    amount_cents: v.pipe(v.union([
        ...
        v.string(),
        v.bigint()
    ]), v.transform(x => BigInt(x)), v.minValue(BigInt(1)), v.maxValue(BigInt(9007199254740991))),
...
export const vSandboxRunBillingSummary = v.strictObject({
    ...
    pricing_phase: v.optional(v.string()),
    reserved_charge_units: v.pipe(v.string(), v.regex(/^[0-9]+$/)),
    window_count: v.pipe(v.number(), v.integer(), v.minValue(-2147483648, 'Invalid value: Expected int32 to be >= -2147483648'), v.maxValue(2147483647, 'Invalid value: Expected int32 to be <= 2147483647')),
    writeoff_charge_units: v.pipe(v.string(), v.regex(/^[0-9]+$/))
});
...
export const vSandboxRunLogSearchResult = v.strictObject({
    ...
    seq: v.pipe(v.number(), v.integer(), v.minValue(0), v.maxValue(2147483647, 'Invalid value: Expected int32 to be <= 2147483647')),
    source_kind: v.optional(v.string()),
    stream: v.string(),
    workflow_name: v.optional(v.string()),
 ...
 * OK
 */
export const vListGithubInstallationsResponse = v.nullable(v.array(vSandboxGitHubInstallationRecord));
...
export const vSearchRunLogsQuery = v.object({
    limit: v.optional(v.pipe(v.union([
        ...
        v.string(),
        v.bigint()
    ]), v.transform(x => BigInt(x)), v.minValue(BigInt(1)), v.maxValue(BigInt(500)))),
