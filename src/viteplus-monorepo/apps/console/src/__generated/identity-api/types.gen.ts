...
export type ClientOptions = {
    baseUrl: 'https://identity.api.verself.sh' | (string & {});
};
...
export type RollApiCredentialResponse = RollApiCredentialResponses[keyof RollApiCredentialResponses];
...
export type GetOrganizationMemberCapabilitiesError = GetOrganizationMemberCapabilitiesErrors[keyof GetOrganizationMemberCapabilitiesErrors];
...
export type GetOrganizationMemberCapabilitiesResponse = GetOrganizationMemberCapabilitiesResponses[keyof GetOrganizationMemberCapabilitiesResponses];
...
export type PutOrganizationMemberCapabilitiesError = PutOrganizationMemberCapabilitiesErrors[keyof PutOrganizationMemberCapabilitiesErrors];
...
export type PutOrganizationMemberCapabilitiesResponse = PutOrganizationMemberCapabilitiesResponses[keyof PutOrganizationMemberCapabilitiesResponses];
...
export type UpdateOrganizationMemberRolesError = UpdateOrganizationMemberRolesErrors[keyof UpdateOrganizationMemberRolesErrors];
...
export type UpdateOrganizationMemberRolesResponse = UpdateOrganizationMemberRolesResponses[keyof UpdateOrganizationMemberRolesResponses];
