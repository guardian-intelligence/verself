...
export const patchProject = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).patch<PatchProjectResponses, PatchProjectErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
    url: "/api/v1/projects/{project_id}",
    ...options,
    headers: {
 ...
 */
export const patchProjectEnvironment = <ThrowOnError extends boolean = false>(
  options: Options<PatchProjectEnvironmentData, ThrowOnError>,
) =>
 ...
 */
export const archiveProjectEnvironment = <ThrowOnError extends boolean = false>(
  options: Options<ArchiveProjectEnvironmentData, ThrowOnError>,
) =>
  (options.client ?? client).post<
    ArchiveProjectEnvironmentResponses,
    ArchiveProjectEnvironmentErrors,
...
export const restoreProject = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<RestoreProjectResponses, RestoreProjectErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
