 ...
 */
export const listSourceRepositories = <ThrowOnError extends boolean = false>(
  options?: Options<ListSourceRepositoriesData, ThrowOnError>,
) =>
 ...
 */
export const createSourceRepository = <ThrowOnError extends boolean = false>(
  options: Options<CreateSourceRepositoryData, ThrowOnError>,
) =>
  (options.client ?? client).post<
    CreateSourceRepositoryResponses,
    CreateSourceRepositoryErrors,
 ...
 */
export const getSourceRepository = <ThrowOnError extends boolean = false>(
  options: Options<GetSourceRepositoryData, ThrowOnError>,
) =>
  (options.client ?? client).get<
    GetSourceRepositoryResponses,
    GetSourceRepositoryErrors,
 ...
 */
export const getSourceBlob = <ThrowOnError extends boolean = false>(
  options: Options<GetSourceBlobData, ThrowOnError>,
) =>
  (options.client ?? client).get<GetSourceBlobResponses, GetSourceBlobErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
 ...
 */
export const createSourceCheckoutGrant = <ThrowOnError extends boolean = false>(
  options: Options<CreateSourceCheckoutGrantData, ThrowOnError>,
) =>
  (options.client ?? client).post<
    CreateSourceCheckoutGrantResponses,
    CreateSourceCheckoutGrantErrors,
 ...
 */
export const listSourceRefs = <ThrowOnError extends boolean = false>(
  options: Options<ListSourceRefsData, ThrowOnError>,
) =>
  (options.client ?? client).get<ListSourceRefsResponses, ListSourceRefsErrors, ThrowOnError>({
    security: [{ scheme: "bearer", type: "http" }],
 ...
 */
export const getSourceTree = <ThrowOnError extends boolean = false>(
  options: Options<GetSourceTreeData, ThrowOnError>,
) =>
