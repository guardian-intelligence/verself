...
CREATE USER IF NOT EXISTS nomad_observer IDENTIFIED WITH ssl_certificate SAN 'URI:__CLICKHOUSE_SPIFFE_SERVICE_PREFIX__/nomad-observer' HOST LOCAL;
ALTER USER nomad_observer IDENTIFIED WITH ssl_certificate SAN 'URI:__CLICKHOUSE_SPIFFE_SERVICE_PREFIX__/nomad-observer' HOST LOCAL;
