  ...
  group "auth-control-plane" {
    ...
    task "auth-control-plane" {
      ...
      env {
        ...
        AUTH_CONTROL_PLANE_DISCOVERY_MANIFEST_PATH = "/var/www/verself/.well-known/verself"
        AUTH_CONTROL_PLANE_PRODUCT_PROJECT_ID = "__VERSELF_ZITADEL_PRODUCT_PROJECT_ID__"
        AUTH_CONTROL_PLANE_PUBLIC_STATE_DIR = "/var/lib/verself/bootstrap/iam-service"
        ...
        AUTH_CONTROL_PLANE_GITHUB_LOGIN_CLIENT_ID = "__VERSELF_GITHUB_LOGIN_CLIENT_ID__"
