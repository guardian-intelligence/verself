...
func (d CloudflareRecovery) Validate() error {
	if strings.TrimSpace(d.APIVersion) != APIVersion {
...
func (k ObjectStorageRuntimeKeys) Map(adminAccessKeyID, adminSecretAccessKey, proxyAccessKeyID, proxySecretAccessKey string) map[string]string {
...
func RequiredPath(path, field string) (string, error) {
