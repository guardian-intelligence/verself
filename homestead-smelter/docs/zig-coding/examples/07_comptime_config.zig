    ...
    return struct {
        fn greeting() []const u8 {
            return switch (target) {
                .v1 => "PONG homestead-smelter-host",
                .v2 => "PONG homestead-smelter-host v2",
            };
        }
...
test "comptime protocol dispatch — v1" {
    ...
    try std.testing.expectEqualStrings("PONG homestead-smelter-host", v1.greeting());
    try std.testing.expectEqual(@as(usize, 4096), v1.maxPayload());
}

test "comptime protocol dispatch — v2" {
    const v2 = protocolVersion(.v2);
    try std.testing.expectEqualStrings("PONG homestead-smelter-host v2", v2.greeting());
