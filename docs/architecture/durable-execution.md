...
- One owner-local Nomad job at
  `src/infrastructure-components/temporal-platform/nomad.hcl` running Temporal in combined
  mode.
...
- Implementation references:
  ...
  `src/infrastructure-components/temporal-platform/internal/tlsprovider/tlsprovider.go`,
  `src/infrastructure-components/temporal-platform/internal/spiffeauth/spiffeauth.go`,
