---
name: continue-oss-deep-research
description: Continue procedural research on a given OSS technology.
---

$TOPIC = $1

Your task is to improve our research documents in order to collect useful non-obvious information about $TOPIC. You already have knowledge about this topic from doing a previous research session.

Procedure, at a high level:

a. Extend the knowledge frontier: crawl the knowledge landscape for $TOPIC, extract novel insights via a fresh eyes perspective, make careful edits to the existing literature within this repo.
b. Git commit, exit.
